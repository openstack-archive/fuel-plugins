...
mapping = [
    ...
    },
    {
        ...
        'builder': builders.BuilderV3  # build process have not changed
    },
    {
        'version': '5.0.',
        'templates': [
...
def get_config_for_plugin_package_version(version):
...
def get_plugin_package_config_for_path(plugin_metadata_path):
    ...
    return get_config_for_plugin_package_version(package_version)
