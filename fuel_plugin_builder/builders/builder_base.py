...
class BuilderBase(actions.BaseAction):
    ...
    def __init__(self, plugin_path, loader=None):
        ...
        if self.data.report.is_failed():
            raise Exception(self.data.report.render())
    ...
    def _validate(self):
        return fuel_plugin_builder.version_mapping.get_validator(self.plugin_path).validate(self.data)
