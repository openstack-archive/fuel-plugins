...
class SchemaV4(SchemaV3):
    ...
    def _gen_task_schema(
        ...
        return {
            ...
            # note(ikutukov): strictness is higher that for v3
    ...
    @property
    def group_task(self):
        group_task_schema = self._gen_task_schema(
            "group",
            ['role'],
            {
                'type': 'object',
        ...
        group_task_schema['properties'].update(
            {
                'tasks': {
                    'type': 'array',
                    'items': {
