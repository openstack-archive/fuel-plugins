...
from fuel_plugin_builder.validators import base
from fuel_plugin_builder.validators import validator_v5


class BaseValidatorTestCase(FakeFSTest):
    fake_fs_source_path = None
    validator = None
    ValidatorClass = base.BaseValidator
...
class ValidatorV5TestCase(BaseValidatorTestCase):
    ...
    ValidatorClass = validator_v5.ValidatorV5
