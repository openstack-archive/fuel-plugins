...
from fuel_plugin_builder.tests.test_validator_base import BaseValidatorTestCase


class TestValidatorV5(BaseValidatorTestCase):
    validator_class = validators.ValidatorV5
    loader_class = loaders.LoaderV5
