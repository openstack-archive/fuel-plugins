...
from fuel_plugin_builder.version_mapping import get_config_for_plugin_package_version


class TestVersionMapping(BaseTestCase):

    def test_get_plugin_for_version_5(self):
        result = get_config_for_plugin_package_version('5.0.0')
    ...
    def test_get_plugin_for_version_raises_error(self):
        with self.assertRaisesRegexp(Exception,
            ...
            get_config_for_plugin_package_version('2999')
