...
class TestChecks(TestCase):
    ...
    @mock.patch('fuel_plugin_builder.validators.checks.utils.parse_yaml')
    def test_env_config_attr_pass(self, parse_yaml_m):
        parse_yaml_m.return_value = {}
    ...
    @mock.patch('fuel_plugin_builder.validators.checks.utils.parse_yaml')
    def test_check_env_config_attrs_checks_metadata(self, parse_yaml_m):
        check = EnvConfigAttrsIsValidV1()
    ...
    @mock.patch('fuel_plugin_builder.validators.checks.utils.parse_yaml')
    def test_check_env_config_attrs_checks_attrs(self, parse_yaml_m):
        check = EnvConfigAttrsIsValidV1()
        parse_yaml_m.return_value = {
            'attributes': {
                'key1': {
    ...
    @mock.patch('fuel_plugin_builder.validators.checks.utils.parse_yaml')
    def test_check_env_config_attrs_restriction_fails(self, parse_yaml_m):
        check = EnvConfigAttrsIsValidV1()
        parse_yaml_m.return_value = {
            'attributes': {
                'key1': {
