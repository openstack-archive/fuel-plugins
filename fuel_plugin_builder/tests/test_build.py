...
from fuel_plugin_builder.builders import BuilderV1
from fuel_plugin_builder.builders import BuilderV2
from fuel_plugin_builder.builders import BuilderV3
...
class TestBuilderV3(BaseBuildTestCase):
    ...
    def test_make_package_with_build_version(
        ...
        self.builder = self._create_builder(self.plugin_path, fake_metadata=meta)
        self._test_make_package()
