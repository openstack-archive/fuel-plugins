...
class TestUtils(BaseTestCase):
    ...
    @mock.patch('utils.fs.os.path.isfile',
                return_value=True)
    @mock.patch('utils.fs.os.access',
                return_value=True)
    ...
    @mock.patch('utils.fs.os')
    @mock.patch('utils.fs.is_executable',
                return_value=True)
    ...
    @mock.patch('utils.is_executable',
                return_value=False)
    ...
    @mock.patch('utils.fs.os.path.lexists',
                return_value=True)
    ...
    @mock.patch('utils.fs.os.path.basename')
    ...
    @mock.patch('utils.fs.copy')
    @mock.patch('utils.fs.glob.glob',
    ...
    @mock.patch('utils.fs.shutil.move')
    @mock.patch('utils.fs.glob.glob',
                return_value=['file1', 'file2'])
    ...
    @mock.patch('utils.fs.copy_file_permissions')
    @mock.patch(
        'utils.template.load_template_and_render_to_file')
    @mock.patch('utils.fs.remove')
    @mock.patch('utils.fs.os.walk')
    ...
    @mock.patch('utils.checksum.calculate_file_sha')
    @mock.patch('utils.fs.os.walk')
    ...
    @mock.patch('utils.checksum.calculate_file_checksums')
