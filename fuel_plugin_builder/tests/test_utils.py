...
class TestUtils(BaseTestCase):
    ...
    @mock.patch('fuel_plugin_builder.utils.fs.os.path.isfile', return_value=True)
    @mock.patch('fuel_plugin_builder.utils.fs.os.access', return_value=True)
    ...
    @mock.patch('fuel_plugin_builder.utils.fs.os.path.isfile', return_value=True)
    @mock.patch('fuel_plugin_builder.utils.fs.os.access', return_value=False)
    ...
    @mock.patch('fuel_plugin_builder.utils.fs.is_executable', return_value=True)
    ...
    @mock.patch('fuel_plugin_builder.utils.fs.os.path.lexists', return_value=True)
    ...
    @mock.patch('fuel_plugin_builder.utils.fs.copy_file_permissions')
    @mock.patch(
