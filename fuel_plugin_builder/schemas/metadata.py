    ...
    def metadata(self):
        return {
            ...
            'properties': {
                'name': {
                    'type': 'string',
                    'pattern': common_v1_0_0.plugin_name_pattern
                },
                'title': {'type': 'string'},
                'version': {'type': 'string'},
                'package_version': {
                    'enum': [self.package_version]
                },
                'description': {'type': 'string'},
                'fuel_version': common_v1_0_0.list_of_strings,
                'licenses': common_v1_0_0.list_of_strings,
                'authors': common_v1_0_0.list_of_strings,
                'groups': {
                    'type': 'array',
                    'uniqueItems': True,
                    'items': {
